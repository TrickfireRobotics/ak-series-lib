...
export default defineConfig({
    ...
    description: "Development guide and low level code documentation for the CubeMars AK Series driver board's. A deep dive into the code that controls our motors and how to contribute.",
    landing: [
{
